...
import { emptyCart } from '../redux/cartSlice'; // adjust path if different
...
const OrderSuccess = () => {
  ...
  useEffect(() => {
    ...
    // Clear DB cart (optional, only if you store cart in MongoDB)
    fetch(`${import.meta.env.VITE_BACKEND_URL}/api/cart/clear`, {
      method: 'DELETE',
      credentials: 'include'
